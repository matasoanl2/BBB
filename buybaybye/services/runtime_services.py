...
from buybaybye.modules.betting import place_bets_combined_slots as _betting_place_bets_combined_slots
...
class RuntimeServices:
    ...
    async def place_bets_combined_slots(
        ...
        *,
        ...
        """Разместить одним POST ставки двух слотов, синхронно обновив оба betting_state."""

        return await _betting_place_bets_combined_slots(
            page,
            slot1_targets=tuple(slot1_targets),
            slot1_amount=slot1_amount,
            slot2_targets=tuple(slot2_targets),
            ...
            calculate_roi_2_func=self.calculate_roi_2,
            format_outcome_pretty_func=self.betting.format_outcome_pretty,
            format_bet_log_func=self.betting.format_bet_log,
            get_balance_for_log_func=self.get_balance_for_log,
            get_db_connection_func=self.get_db_connection,
            ...
            reload_page_and_refresh_token_func=self.reload_page_and_refresh_token,
            advance_step_after_set_error_func=self.advance_step_after_set_error,
            advance_step_2_after_set_error_func=self.advance_step_2_after_set_error,
            update_runtime_snapshot_func=self.update_runtime_snapshot,
            queue_telegram_notification_func=self.queue_telegram_notification,
        )
    ...
    async def process_betting_round(self, page, payload: object) -> None:
        ...
        await _betting_process_betting_round(
            ...
            update_dynamic_bet_2_func=self.betting.update_dynamic_bet_2 if self.runtime_config.betting.secondary_enabled else None,
            ...
            place_bets_combined_slots_func=(
                self.place_bets_combined_slots if self.runtime_config.betting.secondary_enabled else None
            ),
